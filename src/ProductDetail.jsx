import React, { useEffect, useState, useRef } from 'react'; // 1. Corregido: añadimos useRef
import { useParams, useNavigate } from 'react-router-dom';
import {
  XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, AreaChart, Area
} from 'recharts';

// 2. Corregido: añadimos setIsDarkMode, searchTerm y setSearchTerm a los argumentos
const ProductDetail = ({ API_BASE, isDarkMode, setIsDarkMode, searchTerm, setSearchTerm }) => {
  ...
  const searchRef = useRef(null); // Ahora sí funcionará porque importamos useRef
  ...
  return (
    <div className={`detail-page ${isDarkMode ? 'dark' : 'light'}`}>
      ...
      <div className="detail-container" style={{ marginTop: '80px' }}>
